      ...
      <div class="col-12 col-xl-8">
        <div class="card">
          ...
          <div class="card-body pt-0">
            <div class="row g-3">
              <div class="col-12">
                <input type="text" name="title" class="form-control" id="title" placeholder="{{ __('Lesson Title') }}" required />
              </div>
              <div class="col-12">
                <textarea name="highlights" class="form-control" id="highlights" cols="30" rows="10" placeholder="{{ __('Type lesson highlights here ...') }}"></textarea>
              </div>
            </div>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body pt-0">
            <div class="row g-3">
              <div class="col-12">
                <textarea name="description" class="form-control" id="description" cols="30" rows="24" placeholder="{{ __('Type lesson details here ...') }}"></textarea>
              </div>
            </div>
          </div>
        </div>
