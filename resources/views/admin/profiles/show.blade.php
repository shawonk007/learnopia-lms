    ...
    <div class="col-md-4 col-xl-3">
      <div class="card mb-3">
        <div class="card-header">
          <h5 class="card-title mb-0">{{ Auth::guard('admin')->user()->firstname . ' ' . Auth::guard('admin')->user()->lastname }}</h5>
        </div>
        <div class="card-body text-center">
          ...
          <div>
            <a class="btn btn-primary btn-sm" href="{{ route('edit.profile', Auth::guard('admin')->user()->username) }}">
              <span data-feather="message-square"></span>
              <span class="ps-1">{{ __('Modify') }}</span>
            </a>
            <a class="btn btn-primary btn-sm" href="#">
              <span data-feather="message-square"></span>
              <span class="ps-1">{{ __('Delete') }}</span>
            </a>
          </div>
        </div>
                <hr class="my-0" />
