              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <div class="input-group">
                    <input type="text" name="firstname" class="form-control" id="fName" placeholder="{{ __('First Name') }}" value="{{ Auth::user()->firstname }}" required />
                    <input type="text" name="lastname" class="form-control" id="lName" placeholder="{{ __('Last Name') }}" value="{{ Auth::user()->lastname }}" required />
                  </div>
                </div>
                <div class="col-6">
                  <input type="text" name="username" class="form-control" id="uName" placeholder="{{ __('Username') }}" value="{{ Auth::user()->username }}" required />
                </div>
                <div class="col-6">
                  <input type="date" name="date_of_birth" class="form-control" id="dob" value="{{ isset(Auth::user()->profile->date_of_birth) ? Auth::user()->profile->date_of_birth : '' }}" />
                </div>
                <div class="col-12">
                  <input type="email" name="email" class="form-control" id="email" placeholder="{{ __('Primary Email') }}" value="{{ Auth::user()->email }}" required />
                </div>
                <div class="col-6">
                  <input type="tel" name="phone" class="form-control" id="phone" placeholder="{{ __('Primary Phone') }}" value="{{ Auth::user()->phone }}" required oninput="formatPhoneNumber(this)" maxlength="19" />
                </div>
              </div>
            </div>
